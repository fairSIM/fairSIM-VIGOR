/*//GEN-FIRST:event_exposureButtonActionPerformed
This file is part of Free Analysis and Interactive Reconstruction//GEN-LAST:event_exposureButtonActionPerformed
...
public class CameraPanel extends javax.swing.JPanel implements AbstractClient.ClientGui, EasyGui.Cam {
    ...
    private void roiButtonActionPerformed(java.awt.event.ActionEvent evt) {                                          
        setRoi();
    }                                         

    private void exposureButtonActionPerformed(java.awt.event.ActionEvent evt) {                                               
        setExposureTime();
    }                                              

    private void groupBoxItemStateChanged(java.awt.event.ItemEvent evt) {                                          
        groupBoxSelected();
    }                                         
    ...
    private void exposureFieldKeyPressed(java.awt.event.KeyEvent evt) {                                         
